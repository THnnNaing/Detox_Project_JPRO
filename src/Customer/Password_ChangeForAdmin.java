...
public class Password_ChangeForAdmin extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Password_ChangeForAdmin frame = new Password_ChangeForAdmin(new Staff());
	 ...
	 * Create the frame.
	 */
	public Password_ChangeForAdmin(Staff s) {
...
//			
		...
		btnConfirm.setBounds(339, 282, 117, 33);
